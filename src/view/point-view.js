...
const createDestinationPointTemplate = (point) => {
  ...
  return `<li class="trip-events__item">
    <div class="event">
      <time class="event__date" datetime="${getDate(date_from)}">${getMonthDay(date_from)}</time>
      ...
      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${getDatetime(date_from)}">${getTime(date_from)}</time>
          &mdash;
          <time class="event__end-time" datetime="${getDatetime(date_to)}">${getTime(date_to)}</time>
        </p>
        <p class="event__duration">${getMinutesInterval(date_from, date_to)}</p>
      </div>

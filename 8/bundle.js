...
const generateType = () => {
  ...
  return (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_0__.getRandomElement)(types);
};
...
const generateOffers = () => {
  ...
  for (let i = 0; i < (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInteger)(1, 2); i++) {
    const offers = [];

    for (let j = 0; j < (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInteger)(0, 3); j++) {
...
const generatePoint = () => {
  ...
  return {
    ...
    id: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInteger)(1, 1000),
    ...
    <form class="event event--edit" action="#" method="post">
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${(0,_utils_date_time_js__WEBPACK_IMPORTED_MODULE_1__.getFormDate)(dateFrom)}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${(0,_utils_date_time_js__WEBPACK_IMPORTED_MODULE_1__.getFormDate)(dateTo)}">
        </div>
      ...
      <section class="event__details">
        ...
        ${(0,_utils_point_tools_js__WEBPACK_IMPORTED_MODULE_0__.createFormOffersTemplate)(offers)}
...
class FormCreateView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(point) {
    super();
  ...
  get template() {
    return createFormCreateTemplate(_classPrivateFieldGet(this, _point));
  }
...
class FormEditView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(point) {
    super();
  ...
  get template() {
    return createFormEditTemplate(_classPrivateFieldGet(this, _point));
  }
  ...
  return `<li class="trip-events__item">
    <div class="event">
      ...
      <div class="event__schedule">
        ...
        <p class="event__duration">${(0,_utils_date_time_js__WEBPACK_IMPORTED_MODULE_0__.getMinutesInterval)(dateFrom, dateTo)}</p>
      </div>
...
const createTripInfoTemplate = points => {
  ...
  return `<section class="trip-main__trip-info  trip-info">
    <div class="trip-info__main">
      ...
      <p class="trip-info__dates">${(0,_utils_date_time_js__WEBPACK_IMPORTED_MODULE_0__.getMonthDay)(dateFrom)}&nbsp;&mdash;&nbsp;${(0,_utils_date_time_js__WEBPACK_IMPORTED_MODULE_0__.getDay)(dateTo)}</p>
    </div>
...
class TripInfoView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(points) {
    super();
...
/* harmony import */ var _view_form_edit_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/form-edit-view.js */ "./src/view/form-edit-view.js");
...
/* harmony import */ var _view_site_menu_view_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/site-menu-view.js */ "./src/view/site-menu-view.js");
/* harmony import */ var _view_sort_view_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/sort-view.js */ "./src/view/sort-view.js");
...
/* harmony import */ var _mock_destinationPoint_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./mock/destinationPoint.js */ "./src/mock/destinationPoint.js");
/* harmony import */ var _utils_point_tools_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/point-tools.js */ "./src/utils/point-tools.js");
/* harmony import */ var _utils_converter_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/converter.js */ "./src/utils/converter.js");
...
const points = (0,_utils_point_tools_js__WEBPACK_IMPORTED_MODULE_11__.sortPointsByDate)(Array.from({
  length: POINT_COUNT
}, () => (0,_utils_converter_js__WEBPACK_IMPORTED_MODULE_12__.convertPoint)((0,_mock_destinationPoint_js__WEBPACK_IMPORTED_MODULE_10__.generatePoint)())));
...
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(tripMainElement, new _view_trip_info_view_js__WEBPACK_IMPORTED_MODULE_8__["default"](points), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.AFTERBEGIN);
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(siteMenuElement, new _view_site_menu_view_js__WEBPACK_IMPORTED_MODULE_6__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(filterElement, new _view_filter_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);

if ((points === null || points === void 0 ? void 0 : points.length) > 0) {
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(tripEventsElement, new _view_sort_view_js__WEBPACK_IMPORTED_MODULE_7__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(tripEventsElement, new _view_event_list_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);
} else {
  const message = 'Click New Event to create your first point';
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(tripEventsElement, new _view_empty_list_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](message), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);
}

const eventListElement = tripEventsElement.querySelector('.trip-events__list');

if ((points === null || points === void 0 ? void 0 : points.length) > 0) {
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(eventListElement, new _view_form_create_view_js__WEBPACK_IMPORTED_MODULE_3__["default"](points[0]), _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);
}

const renderPoint = (listElement, point) => {
  const pointComponent = new _view_point_view_js__WEBPACK_IMPORTED_MODULE_5__["default"](point);
  const formEditComponent = new _view_form_edit_view_js__WEBPACK_IMPORTED_MODULE_4__["default"](point);
  ...
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(listElement, pointComponent.element, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__.RenderPosition.BEFOREEND);
};
